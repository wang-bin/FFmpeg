...
const AVCodec ff_hevc_libde265_decoder = {
    .name         = "libde265",
    ...
    .capabilities = AV_CODEC_CAP_DELAY | AV_CODEC_CAP_AUTO_THREADS | AV_CODEC_CAP_SLICE_THREADS, //AV_CODEC_CAP_DR1
    .priv_class   = &de265_dec_class,
    .caps_internal  = FF_CODEC_CAP_INIT_THREADSAFE |
                      FF_CODEC_CAP_INIT_CLEANUP,
    .wrapper_name = "libde265",
};
